                    ...
                    <?php if (isAdmin()) : ?>
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="abonne_liste.php"><i class="fa fa-users"></i> Liste</a>
                                <a class="dropdown-item" href="abonne_ajouter.php"><i class="fa fa-user-plus"></i> Ajouter</a>
                            </div>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="livre_liste.php"><i class="fa fa-book"></i> Liste</a>
                                <a class="dropdown-item" href="livre_ajouter.php"><i class="fa fa-plus-square"></i> Ajouter</a>
                            </div>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
